            ...
            <TextField
                ...
                sx={{
                    '& .MuiOutlinedInput-root': {
                        borderRadius: '12px',
                        backgroundColor: isOrange ? 'var(--color-erp-accent)' : 'rgba(229, 231, 235, 0.5)',
                        color: isOrange ? '#000' : 'inherit',
                        '& fieldset': {
                            borderColor: isRejected ? '#EF4444' : 'var(--color-erp-accent)',
                    ...
                    '& .MuiInputLabel-root': {
                        ...
                        '&.Mui-focused': {
                            color: isRejected ? '#EF4444' : (isOrange ? '#000' : 'var(--color-erp-accent)'),
                        },
                    },
