        ...
        <div className="min-h-screen  flex items-center justify-center p-4">
            <div className="bg-[#ffffffad] rounded-[32px] shadow-xl p-16 max-w-3xl w-full text-center flex flex-col items-center justify-center min-h-[400px] relative overflow-hidden">
                ...
                <h2 className="text-xl md:text-2xl text-gray-500 font-medium relative z-10">
                    Wishing You A <span className="text-erp-accent font-semibold">Productive</span> Day!
                </h2>
                ...
                {location.state?.from === 'customer-register' ? (
                    <div className="mt-10 flex flex-col sm:flex-row gap-4 relative z-10">
                        <button
                            ...
                            className="px-8 py-3 rounded-full bg-erp-accent text-white font-semibold hover:bg-erp-accent/80 transition-colors shadow-md"
                        >
                            View Entire Customer List
                        </button>
                        <button
                            onClick={() => navigate(PATHS.ROOT)}
                            className="px-8 py-3 rounded-full border-2 border-erp-accent text-erp-accent font-semibold hover:bg-amber-50 transition-colors"
                        >
                    ...
                    <button
                        ...
                        className="mt-12 text-gray-400 hover:text-erp-accent transition-colors text-sm font-medium flex items-center gap-1 relative z-10"
                    >
